...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   WheelieBabes: () => (/* binding */ WheelieBabes)
/* harmony export */ });
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@types/leaflet-gpx'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class WheelieBabes {
    ...
    constructor(content) {
        ...
        this.fuse = new fuse_js__WEBPACK_IMPORTED_MODULE_2__["default"](Object.values(this.content), searchOptions);
    ...
    populateNav(contents = null) {
        ...
        const paginate = this.paginate(contents.length, this.currentPage, 10, 999);
        ...
        if (this.paginationWrapper) {
            ...
            pages.forEach((page) => {
                this.paginationWrapper?.insertAdjacentHTML("beforeend", `<button id='page-${page}' class="${page === this.currentPage ? "active-page" : ""}">${page}</button>`);
                document
        ...
        contents.forEach((content, i) => {
            if (this.contentList) {
                this.contentList.insertAdjacentHTML("beforeend", `
    ...
    reloadLightbox() {
        const directFigures = this.contentWrapper?.querySelectorAll(":scope > figure");
        if (directFigures) {
            directFigures.forEach((figure) => {
                const nestedFigures = figure.querySelectorAll(":scope > figure");
                if (nestedFigures) {
                    const mediaWrappers = [];
                    nestedFigures.forEach((nestedFigure) => {
                        ...
                        if (media) {
                            ...
                            mediaWrapper.setAttribute("data-gallery", "gallery");
    ...
    addTrack(track) {
        const day = track.split("/");
        const dayNum = day[day.length - 1].split(".")[0];
        ...
        gpxLayer
            ...
            const coordinates = geoJSONSegment.features[0].geometry.coordinates.map((coord) => [coord[1], coord[0]]);
